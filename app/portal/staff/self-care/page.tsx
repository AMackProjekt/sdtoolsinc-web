...
const AFFIRMATIONS = [
  "You make a difference in someone's life every single day.",
  "Your presence and compassion matter more than you know.",
  "It's okay to rest — you cannot pour from an empty cup.",
  "You are doing meaningful work, even when it feels hard.",
  "Setting boundaries is how you protect the energy you give.",
  "Your well-being is just as important as those you serve.",
  "You are allowed to feel, to pause, and to begin again.",
  "The care you give others starts with the care you give yourself.",
  "Your resilience is remarkable — honour it today.",
  "Even the smallest victories in your work ripple outward.",
];
...
const PLAYLISTS = [
  { name: "Lo-Fi Focus", desc: "Calm beats for focused casework", url: "https://www.youtube.com/watch?v=jfKfPfyJRdk" },
  { name: "Ambient Peace", desc: "Relaxing soundscapes between sessions", url: "https://www.youtube.com/watch?v=5qap5aO4i9A" },
  { name: "Deep Work", desc: "Instrumental for documentation flow", url: "https://www.youtube.com/watch?v=FXQX78fBpuQ" },
...
const REFLECTIONS = [
  "What's one moment from today that reminded me why I do this work?",
  "How did I support someone today — and how can I honour that effort?",
  "What boundary did I maintain today that protected my energy?",
  "What would I tell a colleague who is struggling the way I am today?",
  "What's one thing I can let go of before I leave for the day?",
];
...
const BREATH_SEQUENCE: { phase: BreathPhase; label: string; color: string; duration: number }[] = [
  { phase: "inhale", label: "Breathe In",  color: "text-sky-300",    duration: 4000 },
...
export default function StaffSelfCarePage() {
  ...
  const [breathColor, setBreathColor] = useState("text-sky-400");
    ...
    >
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-black text-white tracking-tight">Staff Self-Care</h1>
            <p className="text-sm text-slate-400">You give so much — take a moment to restore.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Affirmation */}
          <SectionCard icon={Sparkles} title="Caregiver Affirmation" color="text-pink-400">
          ...
          <SectionCard icon={Wind} title="Box Breathing" color="text-blue-400">
            <div className="flex flex-col items-center gap-4">
              <motion.div
                ...
                className="w-24 h-24 rounded-full border-2 border-sky-500/40 bg-sky-500/10 flex items-center justify-center"
              >
            ...
            <div className="space-y-2">
              {PLAYLISTS.map((p) => (
                ...
                >
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-slate-500 group-hover:text-sky-400 transition shrink-0" />
                </a>
              ))}
            </div>
          </SectionCard>
        ...
        <SectionCard icon={Brain} title="Brain Dump" color="text-yellow-400">
          ...
          <textarea
            ...
            className="w-full rounded-xl bg-slate-800 border border-slate-700 text-white text-sm px-4 py-3 focus:outline-none focus:border-sky-500 placeholder:text-slate-500 resize-none transition"
          />
        ...
        {/* Reflection */}
        <SectionCard icon={Sparkles} title="Reflection Prompt" color="text-sky-400">
          <div className="flex items-start gap-3 mb-4">
            ...
            <button
              ...
              className="text-sky-400 hover:text-sky-300 transition shrink-0 mt-0.5"
            >
