        ...
        <div className="rounded-2xl bg-panel border border-border p-8 shadow-glow">
          ...
          <div className="mb-6 space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-bg px-4 py-3 text-sm font-semibold text-text transition hover:border-teal-500/40 hover:bg-bg/80 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {signingIn === "google" ? (
