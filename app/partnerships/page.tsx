    ...
    <main className="min-h-screen bg-bg">
      ...
      <section className="mx-auto max-w-container px-7 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <GlowCard key={partner.name} className="p-6 sm:p-8 flex items-center justify-center">
              <img
                src={partner.logo}
                alt={partner.name}
      ...
      <section className="mx-auto max-w-container px-7 py-20">
        ...
        <div className="mt-10 flex justify-center">
          <GlowCard className="p-6 sm:p-8 flex items-center justify-center max-w-md w-full">
            <img
      ...
      <section className="mx-auto max-w-container px-7 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <GlowCard key={benefit.title} className="p-6 sm:p-8">
              <div className="text-3xl sm:text-4xl mb-4">{benefit.icon}</div>
              <div className="text-base sm:text-lg font-extrabold tracking-tight text-text mb-2">
                {benefit.title}
              </div>
          ...
          <GlowCard className="p-6 sm:p-8">
            <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-shrink-0">
                <svg className="h-12 w-12 sm:h-16 sm:w-16 text-text" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="mx-auto max-w-container px-7 py-20 text-center">
        <GlowCard className="p-8 sm:p-12">
          <h2 className="h2 px-4">Interested in Partnering?</h2>
          <p className="mt-4 text-muted max-w-[680px] mx-auto px-4">
          ...
          <div className="mt-8">
            <a href="/#contact">
              <button className="inline-flex items-center justify-center rounded-md px-5 sm:px-6 py-2.5 sm:py-3 text-sm font-semibold bg-gradient-to-br from-brand to-brand2 text-[#02131a] hover:shadow-glow transition-shadow">
                Get in Touch
              </button>
            </a>
          </div>
