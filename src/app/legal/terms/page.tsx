      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using CaseFlow Command (the "Platform") operated by Dreams For Change ("DFC," "we," "us," or "our"), you agree to be bound by these Terms of Use. If you do not agree, you must not access or use the Platform. Your continued use constitutes ongoing acceptance of any updates to these Terms.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-2">2. Authorized Users Only</h2>
            <p>This Platform is restricted to individuals who have been granted explicit access by Dreams For Change. Authorized users include:</p>
            <ul className="mt-2 ml-5 list-disc space-y-1 text-slate-400">
              <li><strong className="text-slate-300">Participants (Clients)</strong> — individuals enrolled in DFC programs who have been approved for portal access.</li>
              <li><strong className="text-slate-300">Staff</strong> — DFC case managers and program staff with valid DFC Google Workspace credentials.</li>
              <li><strong className="text-slate-300">Administrators</strong> — DFC supervisors on the authorized admin allowlist.</li>
            </ul>
          ...
          <section>
            ...
            <ul className="mt-2 ml-5 list-disc space-y-1 text-slate-400">
              ...
              <li>Report any suspected breach of PHI immediately to their supervisor and DFC's compliance officer.</li>
            </ul>
          ...
          <section>
            ...
            <p>You are responsible for maintaining the confidentiality of your account credentials. You must enable two-factor authentication where required by the Platform. You must immediately notify DFC of any unauthorized access to your account. DFC is not liable for losses arising from unauthorized access resulting from your failure to protect your credentials.</p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 ml-5 list-disc space-y-1 text-slate-400">
              <li>Use the Platform for any purpose other than authorized DFC program operations.</li>
          ...
          <section>
            ...
            <p>CaseFlow Command is developed and maintained by A MackProjekt for Dreams For Change. All software, design, branding, and content is the intellectual property of DFC and/or A MackProjekt. No portion of the Platform may be copied, reproduced, distributed, or used to create derivative works without prior written consent.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-2">8. Limitation of Liability</h2>
            <p>To the fullest extent permitted by law, DFC and A MackProjekt shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of or inability to use the Platform, even if advised of the possibility of such damages. The Platform is provided "as is" without warranties of any kind.</p>
          </section>
          ...
          <section>
            ...
            <p>DFC reserves the right to update these Terms at any time. Continued use of the Platform following any changes constitutes acceptance of the revised Terms.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-2">11. Contact</h2>
            <p>For questions regarding these Terms, contact: <a href="mailto:compliance@dreamsforchange.org" className="text-teal-400 hover:underline">compliance@dreamsforchange.org</a></p>
          </section>
