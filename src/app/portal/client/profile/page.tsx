...
import { ArrowLeft, Mail, Badge, Shield, Edit2, ExternalLink } from "lucide-react";
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 md:px-8 pb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:gap-6 -mt-16 mb-8 relative z-10">
            <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-teal-500 to-indigo-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg ring-4 ring-white">
              {initials}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Assigned Case Manager</p>
              </div>
              <p className="text-sm font-bold text-charcoal-900">Your Case Manager</p>
            </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-indigo-800">
              Your account is protected by two-factor authentication (2FA). This keeps your information safe and secure. When you sign in, a verification code is sent to your email.
            </p>
          </div>
        </div>
      </div>
